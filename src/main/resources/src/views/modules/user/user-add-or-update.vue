<template>
  <el-dialog
    ...
    <el-form-item label="" prop="socialUuid">
      <el-input v-model="dataForm.socialUuid" placeholder=""></el-input>
    </el-form-item>
    </el-form>
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.socialUuid = data.user.socialUuid
              }
            })
          }
        })
          ...
          if (valid) {
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                'socialUuid': this.dataForm.socialUuid
              })
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.$message({
